...
namespace LeverageApi.Filter {
  public class CacheActionFilter: ActionFilterAttribute {
    ...
    //http://ninjacode11.wordpress.com/category/web-api/

    //This could be from a network source e.g database
    private static ConcurrentDictionary<string, EntityTagHeaderValue> _etTagHeaderValues = new ConcurrentDictionary<string, EntityTagHeaderValue>();
